<template>
      ...
      <div class="mb-6 bg-white rounded-lg shadow p-4">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div class="relative flex-grow max-w-md">
            ...
            <button 
              class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-primary-500"
              @click="applyFilters"
            >
        ...
        <div v-if="hasActiveFilters" class="mt-4 flex flex-wrap items-center gap-2">
          ...
          <div v-if="selectedCategory" class="inline-flex items-center bg-gray-100 text-gray-800 text-xs rounded px-2 py-1">
          ...
          <button 
            @click="resetFilters" 
            class="text-xs text-primary-600 hover:text-primary-800 hover:underline ml-2"
          >
  ...
  export default {
    ...
    setup(props) {
      ...
      const pagination = computed(() => store.getters['products/getPagination'])
      ...
      const changePage = (page) => {
        store.dispatch('products/changePage', page)
      ...
      onMounted(() => {
        ...
        if (route.query.page) {
          store.commit('products/SET_PAGINATION', { currentPage: Number(route.query.page) })
        }
