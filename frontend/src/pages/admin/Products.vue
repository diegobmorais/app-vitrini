    ...
    <div>
      <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        ...
        <div class="mt-4 md:mt-0">
          <router-link 
            to="/admin/produto/criar-produto" 
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p class="text-sm text-gray-700">
                  Mostrando <span class="font-medium">{{ paginationStart }}</span> a <span class="font-medium">{{ paginationEnd }}</span> de <span class="font-medium">{{ totalProducts }}</span> resultados
                </p>
              </div>
              <div>
