                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="h-10 w-10 flex-shrink-0">
                      <img class="h-10 w-10 rounded-full object-cover" :src="service.image || '/placeholder.svg?height=100&width=100'" :alt="service.name">
                    </div>
                    <div class="ml-4">
    ...
    setup() {
      ...
      const filteredServices = computed(() => {
        return services.value.filter(service => {
          ...
          const matchesCategory = !filters.categoryId || service.categoryId === parseInt(filters.categoryId)
