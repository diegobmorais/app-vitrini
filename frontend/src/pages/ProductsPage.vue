                    ...
                    <label :for="`rating-${rating}`" class="ml-2 text-sm text-gray-700 flex items-center">
                      <div class="flex text-amber-400">
                        <span v-for="i in 5" :key="i">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" :class="{'fill-current': i <= rating, 'text-gray-300': i > rating}" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div v-else class="space-y-6">
              ...
              >
                <div class="sm:w-1/3 relative">
                  ...
                  <div v-if="product.discount > 0" class="absolute top-2 left-2 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded">
                    -{{ product.discount }}%
                  </div>
                  <div v-if="product.isNew" class="absolute top-2 right-2 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded">
                    Novo
                  </div>
                </div>
                <div class="p-4 flex-grow flex flex-col">
                  <div class="flex-grow">
                    ...
                    <div class="flex items-center mb-2">
                      <div class="flex text-amber-400">
                        <span v-for="i in 5" :key="i">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" :class="{'fill-current': i <= Math.floor(product.rating), 'text-gray-300': i > Math.floor(product.rating)}" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                          </svg>
                        </span>
                      </div>
                    ...
                    <p class="text-gray-600 mb-4 line-clamp-2">{{ product.description || 'Descrição não disponível.' }}</p>
                  </div>
    ...
    setup() {
      ...
      const products = ref([
        ...
        },
        {
          ...
          categoryId: 2,
          stock: 8,
          description: 'Arranhador de sisal com múltiplas plataformas e brinquedos pendurados. Ideal para gatos ativos.'
        },
        {
          id: 3,
          ...
          price: 49.90,
          image: '/images/product-toy.jpg',
          rating: 4.7,
          isNew: false,
          discount: 0,
          categoryId: 1,
          stock: 20,
          description: 'Brinquedo interativo que estimula a inteligência do seu pet. Dispensa petiscos durante a brincadeira.'
        },
        {
          id: 4,
          ...
          categoryId: 1,
          stock: 5,
          description: 'Cama ortopédica com espuma viscoelástica que se adapta ao corpo do pet, aliviando pontos de pressão.'
        },
        {
          id: 5,
          name: 'Fonte de Água para Pets',
          slug: 'fonte-agua-pets',
          price: 159.90,
          image: '/images/product-water-fountain.jpg',
          rating: 4.6,
          isNew: false,
          discount: 0,
          categoryId: 5,
          stock: 12,
          description: 'Fonte de água com filtro que mantém a água sempre fresca e limpa para seu pet.'
        },
        {
          id: 6,
          ...
          categoryId: 1,
          stock: 25,
          description: 'Coleira antipulgas e carrapatos com proteção de até 8 meses. À prova d\'água.'
        },
        {
          id: 7,
          name: 'Gaiola para Pássaros',
          slug: 'gaiola-passaros',
          price: 249.90,
          image: '/images/product-bird-cage.jpg',
          rating: 4.7,
          isNew: true,
          discount: 0,
          categoryId: 3,
          stock: 3,
          description: 'Gaiola espaçosa com múltiplos poleiros e comedouros. Ideal para canários e calopsitas.'
        },
        {
          id: 8,
          name: 'Aquário Completo',
          slug: 'aquario-completo',
          price: 399.90,
          image: '/images/product-aquarium.jpg',
          rating: 4.8,
          isNew: false,
          discount: 12,
          categoryId: 4,
          stock: 2,
          description: 'Kit completo de aquário com filtro, iluminação LED e decorações. Capacidade de 50 litros.'
        },
        {
          id: 9,
          ...
          categoryId: 5,
          stock: 18,
          description: 'Shampoo hipoalergênico para pets com pele sensível. Fórmula suave e sem fragrância.'
        },
        {
          id: 10,
          name: 'Transportadora para Pets',
          slug: 'transportadora-pets',
          price: 149.90,
          image: '/images/product-carrier.jpg',
          rating: 4.6,
          isNew: false,
          discount: 8,
          categoryId: 5,
          stock: 7,
          description: 'Transportadora resistente e confortável, aprovada para viagens aéreas. Tamanho médio.'
        },
        {
          id: 11,
          ...
          price: 229.90,
          image: '/images/product-feeder.jpg',
          rating: 4.4,
          isNew: true,
          discount: 0,
          categoryId: 5,
          stock: 4,
          description: 'Comedouro automático programável para até 5 refeições diárias. Mantém a ração sempre fresca.'
        },
        {
          id: 12,
          name: 'Casinha para Roedores',
          slug: 'casinha-roedores',
          price: 79.90,
          image: '/images/product-small-house.jpg',
          rating: 4.2,
          isNew: false,
          discount: 0,
          categoryId: 6,
          stock: 9,
          description: 'Casinha de madeira natural para hamsters, coelhos e outros pequenos roedores.'
        }
      ]);
      
      // Categories data
      const categories = ref([
        { id: 1, name: 'Cães', slug: 'caes' },
        { id: 2, name: 'Gatos', slug: 'gatos' },
        { id: 3, name: 'Aves', slug: 'aves' },
        { id: 4, name: 'Peixes', slug: 'peixes' },
        { id: 5, name: 'Acessórios', slug: 'acessorios' },
        { id: 6, name: 'Pequenos Animais', slug: 'pequenos-animais' }
      ]);
