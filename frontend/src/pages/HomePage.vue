        ...
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div v-for="(category, index) in featuredCategories" :key="index" class="category-card">
              <router-link :to="`/products?category=${category.slug}`" class="block bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105">
              ...
              <div class="flex items-center mb-4">
                <div class="text-amber-400 flex">
                  <span v-for="i in 5" :key="i" class="mr-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" :class="{'fill-current': i <= testimonial.rating, 'text-gray-300': i > testimonial.rating}" viewBox="0 0 20 20" fill="currentColor">
      ...
      <section class="py-12 md:py-20 bg-blue-600 text-white">
        <div class="container mx-auto px-4">
          <div class="max-w-2xl mx-auto text-center">
            ...
            <p class="mb-8 opacity-90">Cadastre-se para receber ofertas exclusivas, dicas de cuidados com pets e novidades.</p>
            ...
            <form @submit.prevent="subscribeNewsletter" class="flex flex-col sm:flex-row gap-4">
              <input 
                ...
                class="flex-grow px-4 py-3 rounded-lg text-gray-900"
                required
              />
              <button 
                type="submit" 
    ...
    setup() {
      ...
      const featuredCategories = ref([
        ...
        },
        {
          name: 'Peixes',
          slug: 'peixes',
          image: '/images/category-fish.jpg'
        }
      ]);
