          ...
          <div>
            ...
            >
              <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                <svg v-if="!isLoading" class="h-5 w-5 text-primary-dark group-hover:text-primary-light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    setup() {
      ...
      const submitForm = async () => {
        ...
        try {
          ...
          router.push('/minha-conta') // atualmente era "/"
        } catch (error) {
