      ...
      <div class="container mx-auto px-4">
        ...
        <div class="mb-8">
          ...
          <div class="relative mt-2">
            ...
            <div 
              class="absolute top-0 left-0 h-1 bg-blue-600 transition-all duration-300"
        ...
        <div v-if="currentStep === 0" class="bg-white rounded-lg shadow-md p-6">
          ...
          <div v-else>
            ...
            <div class="border-b border-gray-200 pb-6 mb-6">
              ...
              <div v-for="(item, index) in cart.items" :key="index" class="py-4 border-t border-gray-100 first:border-t-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p v-if="couponMessage" class="mt-2 text-sm" :class="{'text-green-600': couponValid, 'text-red-600': !couponValid}">
                  {{ couponMessage }}
                </p>
              </div>
            ...
            <div v-else-if="payment.method === 'boleto'" class="text-center">
              <div class="bg-gray-100 p-6 rounded-lg mb-4">
                ...
                <div class="flex">
                  <input 
                    type="text" 
                    value="34191.79001 01043.510047 91020.150008 9 87770026000"
                    readonly
                    class="flex-grow px-4 py-2 border border-gray-300 rounded-l-lg bg-white"
                  />
                  <button 
        ...
        <div v-else-if="currentStep === 3" class="bg-white rounded-lg shadow-md p-6 text-center">
          ...
          <p class="text-gray-600 mb-6">
            Enviamos um e-mail de confirmação para <strong>{{ shipping.email }}</strong> com todos os detalhes do seu pedido.
          </p>
    ...
    setup() {
      ...
      const nextStep = () => {
        if (currentStep.value < steps.length - 1) {
          ...
          // Update shipping cost when moving to payment step
